<template>
  <view class="wrapper-wallet-recharge">
    <view class="wallet-recharge-card">
      <image src="/static/images/wallet-recharge-card.png"></image>
    </view>
    ...
    <view class="uni-form">
      <view class="uni-form-item">
        <input class="uni-input" type="text" placeholder="请输入真实姓名"/>
      </view>
      <view class="uni-form-item">
        <input class="uni-input" type="text" placeholder="请输入手机号"/>
      </view>
      <view class="uni-form-item">
